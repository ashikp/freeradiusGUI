...
export default function Edit({ auth, client }) {
    ...
    const submit = (e) => {
        e.preventDefault();
        put(route('radius-clients.update', client.id));
    };

    return (
        <AuthenticatedLayout
            user={auth.user}
            header={<h2 className="font-semibold text-xl text-gray-800 leading-tight">Edit RADIUS Client</h2>}
        >
            <Head title="Edit RADIUS Client" />
